    ...
    public partial interface IV2
    {
        ...
        public interface IStatusRenderingApi
        {
            ...
            public interface IHook : IKokoroV2ApiHook
            {
                ...
                IEnumerable<(Status Status, double Priority)> GetExtraStatusesToShow(
                    IGetExtraStatusesToShowArgs args
                ) => [];
                ...
                (IReadOnlyList<Color> Colors, int? BarSegmentWidth)? OverrideStatusRenderingAsBars(
                    IOverrideStatusRenderingAsBarsArgs args
                ) => null;
                ...
                IStatusInfoRenderer? OverrideStatusInfoRenderer(
                    IOverrideStatusInfoRendererArgs args
                ) => null;
                ...
                IReadOnlyList<Tooltip> OverrideStatusTooltips(IOverrideStatusTooltipsArgs args) =>
                    args.Tooltips;

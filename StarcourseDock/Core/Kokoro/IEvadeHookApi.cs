...
public partial interface IKokoroApi
{
    public partial interface IV2
    {
        ...
        public interface IEvadeHookApi
        {
            ...
            [Obsolete(
                "Use the `(State state, Combat combat, Direction direction, bool forRendering)` overload instead."
            )]
            ...
            /// <returns>The action entry that would be ran.</returns>
            IEvadeActionEntry? GetNextAction(
                State state,
                Combat combat,
                Direction direction,
                bool forRendering
            ...
            public interface IEvadeActionEntry
            {
                ...
                IEvadeActionEntry RegisterPaymentOption(
                    IEvadePaymentOption paymentOption,
                    double priority = 0
                );
                ...
                /// <returns>This object after the change.</returns>
                IEvadeActionEntry RegisterPrecondition(
                    IEvadePrecondition precondition,
                    double priority = 0
                );
                ...
                /// <returns>This object after the change.</returns>
                IEvadeActionEntry RegisterPostcondition(
                    IEvadePostcondition postcondition,
                    double priority = 0
                );
            ...
            public interface IEvadePaymentOption
            {
                ...
                /// <param name="args">The arguments for this method.</param>
                /// <returns>The list of actions to queue.</returns>
                IReadOnlyList<CardAction> ProvideEvadePaymentActions(
                    IProvideEvadePaymentActionsArgs args
                );
                ...
                public interface IIsEvadeActionEnabledArgs
                {
                    ...
                    bool ForRendering =>
                        throw new InvalidProgramException(
                            "Should never be called directly; real implementation in Kokoro"
                        );
                }

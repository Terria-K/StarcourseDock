    ...
    public partial interface IV2
    {
        ...
        public interface IDroneShiftHookApi
        {
            ...
            public interface IDroneShiftActionEntry
            {
                ...
                IDroneShiftActionEntry RegisterPaymentOption(
                    IDroneShiftPaymentOption paymentOption,
                    double priority = 0
                );
                ...
                /// <returns>This object after the change.</returns>
                IDroneShiftActionEntry UnregisterPaymentOption(
                    IDroneShiftPaymentOption paymentOption
                );
                ...
                /// <returns>This object after the change.</returns>
                IDroneShiftActionEntry RegisterPrecondition(
                    IDroneShiftPrecondition precondition,
                    double priority = 0
                );
                ...
                /// <returns>This object after the change.</returns>
                IDroneShiftActionEntry RegisterPostcondition(
                    IDroneShiftPostcondition postcondition,
                    double priority = 0
                );
                ...
                /// <returns>This object after the change.</returns>
                IDroneShiftActionEntry UnregisterPostcondition(
                    IDroneShiftPostcondition postcondition
                );
            ...
            public interface IDroneShiftAction
            {
                ...
                IReadOnlyList<CardAction> ProvideDroneShiftActions(
                    IProvideDroneShiftActionsArgs args
                );
            ...
            public interface IDroneShiftPaymentOption
            {
                ...
                /// <param name="args">The arguments for this method.</param>
                /// <returns>The list of actions to queue.</returns>
                IReadOnlyList<CardAction> ProvideDroneShiftPaymentActions(
                    IProvideDroneShiftPaymentActionsArgs args
                );
            ...
            public interface IHook : IKokoroV2ApiHook
            {
                ...
                bool IsDroneShiftPaymentOptionEnabled(IIsDroneShiftPaymentOptionEnabledArgs args) =>
                    true;
                ...
                bool IsDroneShiftPreconditionEnabled(IIsDroneShiftPreconditionEnabledArgs args) =>
                    true;
                ...
                bool IsDroneShiftPostconditionEnabled(IIsDroneShiftPostconditionEnabledArgs args) =>
                    true;

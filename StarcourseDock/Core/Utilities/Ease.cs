...
public static class Ease
{
    ...
    public static readonly Easer SineIn = (double t) =>
        -(double)Math.Cos(MathHelper.PiOver2 * t) + 1;
    public static readonly Easer SineOut = (double t) => (double)Math.Sin(MathHelper.PiOver2 * t);
    public static readonly Easer SineInOut = (double t) =>
        -(double)Math.Cos(MathHelper.Pi * t) / 2f + .5f;
    ...
    public static readonly Easer BigBackIn = (double t) =>
    {
        return t * t * (4f * t - 3f);
    };
